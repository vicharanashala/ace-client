      ...
      <DialogTemplate
        ...
        buttons={
          <>
            <button
              onClick={onDecline}
              className="inline-flex items-center justify-center rounded-lg border border-border-heavy bg-red-500 px-4 py-2 text-sm text-white hover:bg-red-600 dark:bg-red-600 dark:hover:bg-red-700"
            >
              {/* <span>DECLINE</span> */}
              {'ਅਸਵੀਕਾਰ ਕਰੋ'}
            </button>
            <button
              onClick={onAccept}
              className="inline-flex items-center justify-center rounded-lg border border-border-heavy bg-green-500 px-4 py-2 text-sm text-white hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-700"
            >
